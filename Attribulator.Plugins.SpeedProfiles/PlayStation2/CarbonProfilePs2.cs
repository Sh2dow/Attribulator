...
namespace Attribulator.Plugins.SpeedProfiles.PlayStation2
{
	/// <summary>
	///     Basic profile for PS2 32-bit NFS Carbon
	/// </summary>
	public class CarbonProfilePs2 : IProfile
	{
		...
		{
			return "Need for Speed Carbon (PlayStation 2)";
		}
